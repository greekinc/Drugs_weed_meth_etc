...
RegisterServerEvent('nc-drugprocessing:pickedUpHydrochloricAcid', function()
	local src = source
...
RegisterServerEvent('nc-drugprocessing:pickedUpSodiumHydroxide', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:pickedUpSulfuricAcid', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:processChemicals', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:processTempUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:processTempDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:processMeth', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:processFailUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-drugprocessing:processFailDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
