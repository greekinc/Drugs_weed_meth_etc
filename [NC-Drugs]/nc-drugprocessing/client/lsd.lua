...
local function Processlsd()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('nc-drugprocessing:Processlsd')
...
local function Processthionylchloride()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('nc-drugprocessing:processThionylChloride')
...
RegisterNetEvent('nc-drugprocessing:processingThiChlo', function()
